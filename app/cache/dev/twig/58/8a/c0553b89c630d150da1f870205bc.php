...
/* servicioBundle:Formulario:edit.html.twig */
class __TwigTemplate_588ac0553b89c630d150da1f870205bc extends Twig_Template
{
    ...
    {
        // line 1
        echo "<h1>Formulario edit</h1>

<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("formulario_update", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "servicioBundle:Formulario:edit.html.twig";
    }
