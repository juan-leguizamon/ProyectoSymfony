...
/* servicioBundle:PoliticaCosto:new.html.twig */
class __TwigTemplate_3c3bc77beb664b1baf3539f42e226aa7 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<h1>PoliticaCosto creation</h1>

<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("politicas_create"), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "servicioBundle:PoliticaCosto:new.html.twig";
    }
